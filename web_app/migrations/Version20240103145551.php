 ...
 */
final class Version20240103145551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pdf (id INT NOT NULL, pages_number INT DEFAULT NULL, orientation VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE video (id INT NOT NULL, user_t_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, format VARCHAR(255) DEFAULT NULL, duration INT DEFAULT NULL, PRIMARY KEY(id))');
